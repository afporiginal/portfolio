...
const TECHS = [
  ...
  { name: "Discord.py", icon: "🤖", color: "#5865F2" },
  { name: "Blender", icon: "🎨", color: "#F5792A" },
  { name: "Roblox Studio", icon: "🎮", color: "#E2231A" },
...
const WHAT_I_DO = [
  { icon: "🤖", title: "Discord Bots", desc: "Custom bots with Discord.py — moderation, fun, utilities." },
  { icon: "🎮", title: "Roblox Dev", desc: "Scripting in Lua, game mechanics & systems in Roblox Studio." },
...
const WHAT_I_USE = [
  ...
  { icon: "🐧", title: "Linux", desc: "Main OS — terminal-first workflow." },
  ...
  { icon: "🎮", title: "Roblox Studio", desc: "Game development & Lua scripting." },
];
